...
<main class="container py-5">
    ...
    <ul style="display: flex; justify-content: space-around;" class="schedule-group-button-area">
    <?php
    //存在するグループ分だけリンク生成
    ksort($group_list);
    ...
    $ggname = str_replace("グループ","",$group_name);
    }
    ?>
        <li style="margin-left:-30px; margin-top:1.5em;"><a href="?group=<?=$group_name;?>&y=<?=$tournament;?>"><?=$ggname;?></a></li>
    <?
    }
    ?>
    </ul>
    <ul style="display: flex; justify-content: space-center;" class="schedule-group-button-area">
        <li style="margin-top:1em;margin-right:2em;"><a href="?group=">すべてのチーム</a></li>
    </ul>
