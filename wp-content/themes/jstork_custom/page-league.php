...
<div class="mian-image-area">
    ...
    <img class="main-img" src="https://scjcup.com/wp-content/uploads/2025/07/421080-scaled.jpg" />
    <?php } else { ?>
...
<main class="container py-5">
    ...
    <section class="">
        ...
        <div class="schedule-group-button-area">
                        ...
                        $ggname = str_replace("グループ","",$gname);
                        }
                        ?>
                                <a href="/league/?group=<?=$gname;?>&y=<?=$tournament;?>"><?=$ggname;?></a>
                        <?
                        }
                        ?>
        </div>
...
<?php if ( $tournament == 2025 && strstr($_SERVER['HTTP_USER_AGENT'], "Chrome") ): ?>
        <iframe width="300" height="400" src="<?= home_url(); ?>/web/viewer.html?file=/img/report1.pdf#page=<?= $page ?>&zoom=page-width" allowfullscreen></iframe>
<?php else: ?>
        <embed src="/img/report1.pdf#page=<?= $page ?>" type="application/pdf" width="100%" height="600">

<?php endif; ?>
        <div class="text-sm text-center">
        <a href="<?= home_url(); ?>/img/report1.pdf">pdfファイル</a>
        </div>
        <?php endif; ?>
...
*/?>
                        ...
                        <div style="display:flex; margin-top:0.85em;">
                            <div style="width:50%; padding:0 1em; font-size: 0.8em; display: flex; flex-wrap: wrap; justify-content: flex-end; align-items: flex-start;">
                                ...
                                ?>
                                        <div class="text-center font-bold" style="white-space: nowrap; width: 100%;"><?=$val['scorer_name']->post_content;?>.<?=$val["scorer_name"]->post_title;?></div>
                                <?php
                                        $cnt++;
                                    }
                                }
            ...
            <?php } ?>
                        ...
                        <?php else: ?>
                        <div class="schedule-group-button-area" />
                        <img src="/img/e1710_1<?=$g;?>.png" width=200 style="position:absolute;left:-30px;" /><img src="/img/1737848547401.jpg" width=300  style="margin:20px;"/>
                        </div>
                        <?php endif; ?>
                        <?php } ?>
