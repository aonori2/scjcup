...
<main class="container py-5">
            <section>
                ...
                <div class="px-3 py-2">
                    ...
                    <!-- ジェイコム埼玉・東日本 -->
                    <div class="my-5">
                        <p class="overview-box-2-title font-bold my-2"><a href="https://www.jcom.co.jp/">株式会社ジェイコム埼玉・東日本</a></p>
                        <a href="https://www.jcom.co.jp/"><img class="sponsorship-img" src="<?=get_stylesheet_directory_uri(); ?>/img/sponsorship/Jcom_logo.jpg"></a>
                    </div>
