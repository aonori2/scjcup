...
.article-footer .post-categories li a,.article-footer .tags a,.accordionBtn{  background: <?php echo $mainlink; ?>;  border-color: <?php echo $mainlink; ?>;}
.article-footer .tags a{color:<?php echo $mainlink; ?>; background: none;}
.article-footer .post-categories li a:hover,.article-footer .tags a:hover,.accordionBtn.active{ background:<?php echo $mainlinkhover; ?>;  border-color:<?php echo $mainlinkhover; ?>;}
...
.entry-content h2,.widgettitle,.accordion::before{background: <?php echo $mainttlbg; ?>; color: <?php echo $mainttltext; ?>;}
...
function theme_customize_register($wp_customize) {
	...
	$wp_customize->add_control( 'other_options_ga', array(
		...
		'description' => '<span style="font-size:10px;">入力例：G-12345...<br>※すでにプラグイン等で設定している場合はこちらを設定しないようご注意ください。</span>',
