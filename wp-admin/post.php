...
if ( strstr($_POST['_wp_http_referer'],"/wp-admin/post-new.php") && $_POST["action"]== "editpost" && $_POST["post_type"]=="player" ){
    foreach( $_POST['acf'] as $val ){
    $number = $val;
    break;
    }
    $_POST['post_content'] = $number;
    $_REQUEST['post_content'] = $number;
}
